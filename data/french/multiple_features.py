...
def spec_dataset(dir_src,dir_dest):
    for word in os.listdir(dir_src):
        ...
        for file in os.listdir(word_DIR):
            ...
            graph_spectrogram(filepath,dir_dest + word + "\\" + file[:len(file)-4] + ".png")
            print(file)
...
def mfcc_dataset(dir_src,dir_dest):
    for word in os.listdir(dir_src):
        ...
        for file in os.listdir(word_DIR):
            ...
            mfcc(file_path,dir_dest + word + "\\" + file[:len(file)-4] + ".png","image")
            print(file)
...
def hilbert_dataset(dir_src,dir_dest):
    for word in os.listdir(dir_src):
        ...
        for file in os.listdir(word_DIR):
            file_path = word_DIR + file
            hilbert_spectrum(file_path,dir_dest + word + "\\" + file[:len(file)-4] + ".png")
            print(file)
